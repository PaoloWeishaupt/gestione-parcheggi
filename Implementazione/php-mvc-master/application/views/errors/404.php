                ...
                <div class="container-fluid d-flex align-items-center justify-content-center h-100">
                    ...
                    <div class="row d-flex justify-content-center text-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <!-- Heading -->
                            <h2 class="display-4 font-weight-bold white-text pt-5 mb-2">La pagina che stai cercando non esiste!</h2>

                            <!-- Button to home -->
                            <a class="btn btn-light" href="<?php echo URL.'home/index'; ?>">Torna alla home</a>
