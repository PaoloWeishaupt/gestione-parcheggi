                    ...
                    <div class="row d-flex justify-content-center text-center">
                        ...
                        <div class="col-md-5">
                            ...
                            <form class="text-center border border-light p-5 rounded mb-0 login-form-bg" action="<?php echo URL; ?>offer/offri" method="POST">
                                ...
                                <input type="text" name="car_plate" placeholder="TI-123456" class="form-control mb-4" maxlength="9" value="<?php echo isset($_SESSION['carPlate']) ? $_SESSION['carPlate'] : ""; ?>" pattern="^(AG|AI|AR|BE|BL|BS|FR|GE|GL|GR|JU|LU|NE|NW|OW|SG|SH|SO|SZ|TG|TI|UR|VD|VS|ZG|ZH)-[0-9]{1,6}$" required>
